<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="/libs/%40fancyapps/fancybox/dist/jquery.fancybox.min.css">
      <link rel="stylesheet" href="/libs/%40fortawesome/fontawesome-free/css/all.min.css">
      <link rel="stylesheet" href="/css/quick-website.css" id="stylesheet">
   </head>
   <body class="ready loaded">
     <!--  <div class="preloader">
      ...
      <header class="header-transparent" id="header-main">
         <nav class="navbar navbar-main navbar-expand-lg navbar-dark bg-dark" id="navbar-main">
            <div class="container">
               <a class="navbar-brand" href="../../index-2.html"><img alt="Image placeholder" src="/img/brand/light-mono.svg" id="navbar-logo"> </a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-main-collapse" aria-controls="navbar-main-collapse" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
               <div class="collapse navbar-collapse navbar-collapse-overlay" id="navbar-main-collapse">
                  ...
                  <ul class="navbar-nav align-items-lg-center d-none d-lg-flex ml-lg-auto">
                     <li class="nav-item"><a class="nav-link" href="../authentication/login-basic.html">Sign in</a></li>
                     <li class="nav-item">
      ...
      <script src="/libs/%40fancyapps/fancybox/dist/jquery.fancybox.min.js"></script>
